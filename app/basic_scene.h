...
#define PLANE_DEPTH  0.1f
    ...
    dm_ecs_entity_add_physics_at_rest(entities[entity_count], 1e13f, DM_PHYSICS_BODY_TYPE_RIGID, DM_PHYSICS_MOVEMENT_STATIC);
...
return_code app_update(view_camera* camera)
{
    ...
    //dm_physics_apply_force(entities[entity_count], dm_vec3_set(0,-1e5f, 0));
