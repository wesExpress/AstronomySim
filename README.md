...
Prototype for an astronomy simulation. This project uses my ['single header-file' framework DarkMatter](https://github.com/wesExpress/DarkMatter) for rendering, physics, and general ECS framework.
